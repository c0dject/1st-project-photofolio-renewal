import sympathyDao from '../models/sympathyDao';

// 피드 상세에서 로그인유저의 공감여부 확인
const findSympathyOfFeedByUser = async (
  posting_id: number,
  user_id: number
) => {
...
// 공감취소
const deleteSympathy = async (posting_id: number, user_id: number) => {
